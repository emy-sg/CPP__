...
// Ressource: "Copy assignment operator for derived class" 
...
void ScavTrap::attack(const std::string& target) {
	std::cout << "StavTrap " << name << " attacks " << target << ", causing " << Attack_damage << " points of damage!" << std::endl;
}

void ScavTrap::guardGate() {
	std::cout << "StavTrap " << name << " is now in Gate keeper mode." << std::endl;
}
