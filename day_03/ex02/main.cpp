...
// 	---------------------------------------------
	...
	FragTrap emy("hss"), hss("Me"), msn, nn;

	emy.attack("thief");    // Simple test Get the correct output
	emy.highFivesGuys();

	// test Copy Assignment operator
/*	msn = nn = hss;

	msn.attack("Zombiees");	  // Get the correct output
	nn.attack("llmao");		
*/
	
	// test Copy Constructor
/*	FragTrap mew(emy);
	mew.attack("NONe");		 // Get the correct output
*/
}
