...
void Bureaucrat::signForm(const Form& form) {
	if (form.getSign() == true)
		...
		std::cout << name << " couldn't sign " << form.getName() << " because the grade of the bureacrat is too low." << std::endl;
}
...
void Bureaucrat::executeForm(const Form& form) {
	try {
		...
		std::cout << name << " couldn't execute " << form.getName() << " because the grade of the bureaucrat is too low." << std::endl;
	}
}
